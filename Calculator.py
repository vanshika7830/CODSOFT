...
btn_mul = tk.Button(root, text="*", command=lambda: add_to_calculations("*"), width=5, font=("Arial", 14))
...
btn_equal = tk.Button(root, text="=", command=evaluate_calculations, width=11, font=("Arial", 14))
